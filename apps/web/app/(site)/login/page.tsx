...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ next?: string; authError?: string }> }) {
  ...
  return <SiteShell><section className="mx-auto my-auto w-full max-w-md space-y-5 border border-line border-t-accent bg-panel p-6 sm:p-8">
    <p className="brand-label text-accent">Your workspace is waiting</p>
    <h1 className="font-display text-4xl leading-tight">Sign in to Zedspaces</h1>
