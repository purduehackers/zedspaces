...
export async function SiteShell({ children }: { children: ReactNode }) {
  ...
  return <div className="flex min-h-full flex-1 flex-col font-sans">
    ...
    <footer className="mx-auto flex w-full max-w-6xl flex-wrap justify-between gap-3 border-t border-line px-5 py-5 text-xs text-muted sm:px-8">
      <span>Built by <a href="https://purduehackers.com" className="hover:text-gold">Purdue Hackers</a> and contributors.</span>
      <div className="flex gap-5"><a href="https://github.com/purduehackers/zedspaces#readme" className="hover:text-gold">README</a><a href="https://github.com/purduehackers/zedspaces" className="hover:text-gold">Source</a></div>
    </footer>
  </div>;
}
